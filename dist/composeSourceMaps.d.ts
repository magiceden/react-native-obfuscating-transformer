...
export declare type MetroRawSourceMap = Array<[
    number,
    number,
    number,
    number,
...
export declare function convertStandardSourceMapToMetroRawSourceMap(map: RawSourceMap | string): MetroRawSourceMap;
